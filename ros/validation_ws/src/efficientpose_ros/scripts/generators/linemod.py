...
class LineModGenerator(Generator):
    ...
    def __init__(self, 
                 ...
                 shuffle_dataset = True,
                  symmetric_objects = {"glue", 11, "eggbox", 10,1,2}, #set with names and indices of symmetric objects
                 **kwargs):
        """
        ...
        #print(self.object_path, self.data_examples, self.gt_dict, self.info_dict,'print everything')
        ...
        if self.shuffle_dataset:
            #print(self.image_paths,'image paths')
        ...
        print(self.symmetric_objects,'symmetric objects')
        print(self.class_to_name,'classes')
        #init base class
       ...
       Prepares the Linemod dataset and converts the data from the Linemod format to the EfficientPose format
        ...
        for gt_list in filtered_gt_lists:
            ...
            if len(all_annos) <= 0:
                ...
                filtered_gts.append(all_annos[0])
        #print(sorted(all_filenames),'All filenames')
        #print(sorted(example_ids), 'example ids')
...
if __name__ == "__main__":
    ...
    #train_gen = LineModGenerator("/home/max/Documents/GitHub/thesis/output/bop_data/chess/", object_id = 1)
    test_gen = LineModGenerator("/home/max/Documents/GitHub/thesis/output/bop_data/chess/", object_id = 1, train = False)
